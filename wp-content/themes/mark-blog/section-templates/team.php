            ...
            <div class="row">
				...
				foreach ( $mark_team as $mark_tm ):
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 team-member">
						...
						?>
                        <h3 class="team-title">
							<?php echo esc_html( $mark_tm['name'] ); ?>
                        </h3>
                        ...
                        <div class="team-socail-links">
							<?php
							foreach ( $mark_tm['social_fields'] as $mark_key => $mark_social_field ):
								if ( $mark_social_field != '' ):
									?>
                                    <a href="<?php echo esc_url( $mark_social_field ) ?>"><i
                                                class="fa fa-<?php echo esc_attr( $mark_key ); ?>"></i></a>
								<?php
								endif;
							endforeach;
							?>
