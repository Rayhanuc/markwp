...
if($mark_banner_image_id){
    $mark_banner_image = wp_get_attachment_image_src($mark_banner_image_id,'mark-fullsize');
}else{
				...
				<div class="row justify-content-md-center">
					<div class="col-md-10" data-wow-duration="2s" data-wow-delay="1s">
						...
						<div class="hero-action">
							...
							<a href="<?php echo esc_url($mark_section_meta['button-one-url']); ?>" class="btn btn-light-solid"><?php echo esc_html($mark_section_meta['button-one-label']); ?></a>
							<a href="<?php echo esc_url($mark_section_meta['button-two-url']); ?>" class="btn btn-light-border"><?php echo esc_html($mark_section_meta['button-two-label']); ?></a>
						</div>
					</div>
				</div>
			</div>
