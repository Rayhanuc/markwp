                ...
                <div class="col-md-8">
                    <div id="js_testimonial" class="owl-carousel owl-theme text-center testimonial-wrapper">
						...
						foreach ( $mark_section_meta['testimonials'] as $mark_testimonial ):
							...
							?>
                            <div class="item mb-5"
                                 data-dot="<?php echo esc_attr($mark_testimonial_image_markup); ?> <div class='testimonial-name'><?php echo esc_html($mark_testimonial['title']) ?></div>">
                                <img class="mb-5 quote"
                                     src="<?php echo get_template_directory_uri(); ?>/assets/img/quote.svg" alt=""/>
                                <?php
                                echo apply_filters('the_content',$mark_testimonial['testimonial']);
                                ?>
                            </div>
						<?php
						endforeach;
