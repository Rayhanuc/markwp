            ...
            <div class="col-md-12">
                ...
                <ul class="products">
                    ...
                    <li class="product <?php echo esc_attr($mark_product_class); ?>">
                            ...
                            <span class="price">
                                <del>
                                    <span class="woocommerce-Price-amount amount">
                                        <span class="woocommerce-Price-currencySymbol"><?php _e('$','markwp'); ?></span>
                        ...
                        <a href="<?php echo home_url("/") ."?add-to-cart=".get_the_ID(); ?>" class="button add_to_cart_button"><?php _e('Add to cart','markwp'); ?></a>
                    </li>
                    <?php 
                		endwhile;
                		wp_reset_query();
