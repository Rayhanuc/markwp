            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'about-image',
                        'type' => 'image',
                        'title' => __('About Image', 'mark'),                        
                    ),
                    array(
                        'id' => 'sub-heading',
                        'type' => 'text',
                        'title' => __('About Sub-Heading', 'mark'), 
                        'default' => __('About Us Sub Heading', 'mark'),                       
                    ),
                    array(
                        'id' => 'about-description',
                        'type' => 'wysiwyg', // full form is: What you see is what you get
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => __('About button label', 'mark'),
                        'default' => __('Read More', 'mark'),
                        'dependency'   => array( 'about-button-display', '!=', '' ), 
                    ),
                    array(
                        'id' => 'about-button-url',
                        'type' => 'text',
                        'title' => __('About button url', 'mark'), 
                        'dependency'   => array( 'about-button-display', '!=', '' ), 
                    ),
                )
            )
